...
**Last updated:** 2026-08-18 (Phase 47 완료: quality-scorer 통합 게이트)
...
| **47 — quality-scorer 통합 게이트** | **✅ Complete** | **quality/scorer.py + gate.py: 가중 점수 합산 (contract 0.40, factuality 0.25, role 0.20, visual 0.15) + 발행 게이트 (<7.0 reject, 7.0~8.9 review, 9.0+ publish). chain_publisher.py 게이트 연결 + --force 플래그. 13 신규 테스트. 1016 tests ✅** |
...
- **pytest:** 1016/1021 ✅ (Phase 47: scorer+gate 13건 추가. 기존 5건 실패 무관)
